...
$header .= "From: Новая заявка <dardurranisc@gmail.com>\n\n";	
$mail = mail("dardurranisc@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
